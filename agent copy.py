...
def find_vectorstore_path():
    ...
    search_paths = [
        ...
        "/Users/shamikalikhite/Documents/kitchenCompanion/vectorstore",  # Local dev (last resort)
    ]
...
async def entrypoint(ctx: JobContext):
    ...
    if not rag_ready:
        ...
        print("   To enable RAG, ensure vectorstore/ directory is included in deployment\n")
